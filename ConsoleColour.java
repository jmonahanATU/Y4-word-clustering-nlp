...
/**
 * Enum representing ANSI color codes for console text formatting.
 * Provides various color options for text, background, and text styles.
 *
 * @author Josh Monahan
 * @version 1.0
 * @since JDK22
...
public enum ConsoleColour { 
	...
	/**
     * Constructs a ConsoleColour with description and color code.
     *
     * @param description human-readable description of the color
     * @param colour ANSI color code
     */
	...
	/**
	 * Gets the description of the color format.
	 *
	...
	/**
	 * Gets the ANSI color code string.
	 *
	 * @return String representation of the color code
	 */
